...
shape as customers_raw, minus churn, plus crm_snapshot_at. See
prediction_logging_plan.md Part A. sql/schema/003_create_customers_crm.sql
is deleted once this migration lands (PROJECT_PLAN.md's Phase 10a-i).
"""

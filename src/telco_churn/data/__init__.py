...
__all__ = [
    ...
    "test_ids",
    "write_split",
    # reserve partition (Phase 10a-ii) — constants + helpers
    "RESERVE_COL",
    "load_reserve",
    "make_reserve",
    "reserve_ids",
...
_LAZY_SOURCES: dict[str, str] = {
    ...
    "RESERVE_COL": "telco_churn.data.split",
    "load_reserve": "telco_churn.data.split",
    "make_reserve": "telco_churn.data.split",
    "reserve_ids": "telco_churn.data.split",
    "sealed_test_ids": "telco_churn.data.split",
    "write_reserve": "telco_churn.data.split",
